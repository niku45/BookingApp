...
export default function PhotosUploader({addedPhotos, onChange}){
    ...
    //Upload photo from desktop function
        ...
        <div className='flex gap-2'>
                        ...
                        <div className='mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                            {addedPhotos.length > 0 && addedPhotos.map(link =>(  
                                ...
                                className="cursor absolute bottom-1 right-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3">
                                ...
                                className="cursor absolute bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3">
                               {link === addedPhotos[0] && (
